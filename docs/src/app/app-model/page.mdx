...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Expose built-in <code>window.zero</code> helper namespaces for trusted app chrome. Window, view, and WebView helpers require origin and <code>window</code> checks; dialog and OS helpers still require explicit <code>builtin_bridge</code> policy.</td>
    </tr>
  </tbody>
</table>
